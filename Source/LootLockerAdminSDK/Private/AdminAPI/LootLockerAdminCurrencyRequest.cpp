...
{
	ULootLockerAdminHttpClient::SendRequest<FLootLockerAdminListCurrenciesResponse>(FLootLockerAdminEmptyRequest{}, ULootLockerAdminEndpoints::ListCurrencies, {}, {}, OnResponseCompletedBP, OnResponseCompleted);
}
