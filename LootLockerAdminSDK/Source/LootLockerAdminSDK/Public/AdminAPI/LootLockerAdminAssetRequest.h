...
class LOOTLOCKERADMINSDK_API ULootLockerAdminAssetRequest : public UObject
{
	...
	static void GetAssets(const bool bIncludeInactive, const int Page, const FLootLockerAdminGetAssetsResponseBP& OnCompletedRequestBP = FLootLockerAdminGetAssetsResponseBP(), const FLootLockerAdminGetAssetsResponseDelegate& OnCompletedRequest = FLootLockerAdminGetAssetsResponseDelegate());
};
